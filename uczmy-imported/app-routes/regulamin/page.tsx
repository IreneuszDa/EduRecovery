...
// --- GŁÓWNY KOMPONENT STRONY REGULAMINU ---

export default function Regulamin() {
  const [isScrolled, setIsScrolled] = useState(false);

  // Efekt do wykrywania motywu systemowego i obsługi przewijania
  useEffect(() => {
    // Logika motywu
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 scroll-smooth">
      {/* Nowy, zintegrowany Header */}
      <Header isScrolled={isScrolled} />

      {/* Main Content */}
      <div className="max-w-3xl mx-auto pt-32 pb-20 px-4 sm:px-0">
        <h1 className="text-4xl font-bold mb-8 text-gray-900 dark:text-gray-100">Regulamin serwisu Uczmy.pl</h1>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">1. Wstęp</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Niniejszy regulamin („Regulamin”) określa zasady korzystania z platformy Uczmy.pl („Serwis”).
          Uzyskując dostęp do Serwisu lub korzystając z niego, użytkownik akceptuje postanowienia niniejszego Regulaminu i zobowiązuje się do ich przestrzegania.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">2. Konta użytkowników</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Aby korzystać z niektórych funkcji Serwisu, konieczne może być założenie konta.
          Użytkownik ponosi pełną odpowiedzialność za zachowanie poufności danych swojego konta oraz za wszelkie działania podejmowane z jego wykorzystaniem.
        </p>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Uczmy.pl nie ma dostępu do haseł użytkowników. Prosimy nie udostępniać hasła osobom podającym się za przedstawicieli Uczmy.pl ani innym osobom trzecim.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">3. Dozwolone korzystanie</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Użytkownik zobowiązuje się nie wykorzystywać Serwisu w sposób sprzeczny z prawem ani w sposób, który mógłby zaszkodzić Serwisowi lub utrudniać korzystanie z niego innym użytkownikom.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">4. Własność intelektualna</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Wszystkie treści dostępne w Serwisie, w tym teksty, grafiki, logotypy i oprogramowanie, stanowią własność Uczmy.pl lub jego partnerów i są chronione przepisami prawa autorskiego.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">5. Zawieszenie i zakończenie korzystania</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Uczmy.pl zastrzega sobie prawo do zawieszenia lub zakończenia dostępu użytkownika do Serwisu według własnego uznania, bez wcześniejszego powiadomienia, w przypadku naruszenia Regulaminu lub działań szkodliwych dla innych użytkowników.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">6. Ograniczenie odpowiedzialności</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Serwis udostępniany jest „w stanie takim, w jakim się znajduje”, bez jakichkolwiek gwarancji. Uczmy.pl nie ponosi odpowiedzialności za jakiekolwiek szkody wynikające z korzystania lub niemożności korzystania z Serwisu.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">7. Zmiany Regulaminu</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Uczmy.pl zastrzega sobie prawo do wprowadzania zmian w Regulaminie. Dalsze korzystanie z Serwisu po wprowadzeniu zmian oznacza akceptację zaktualizowanych warunków.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">8. Prawo właściwe</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Regulamin podlega przepisom prawa polskiego i zgodnie z nim będzie interpretowany.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">9. Polityka akademicka</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Zakładając konto na platformie Uczmy.pl, użytkownik akceptuje, że ponosi pełną odpowiedzialność za sposób, w jaki korzysta z Serwisu.
          Uczmy.pl nie ponosi odpowiedzialności za przypadki nieuczciwości akademickiej wynikające z niewłaściwego użycia platformy.
          Użytkownicy zobowiązani są do przestrzegania zasad akademickich obowiązujących w ich instytucjach edukacyjnych.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">10. Kontakt</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          W razie pytań lub wątpliwości dotyczących niniejszego Regulaminu prosimy o kontakt pod adresem: <a href="mailto:pomoc@uczmy.pl" className="underline text-blue-600 dark:text-blue-400">pomoc@uczmy.pl</a>.
        </p>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Wdrożenie zgodności z RODO oraz innymi przepisami międzynarodowymi planowane jest wkrótce.
        </p>
