...
// --- GŁÓWNY KOMPONENT STRONY POLITYKI PRYWATNOŚCI ---

export default function PolitykaPrywatnosci() {
  const [isScrolled, setIsScrolled] = useState(false);

  // Efekt do automatycznego wykrywania motywu systemowego i obsługi przewijania
  useEffect(() => {
    // Logika motywu
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 scroll-smooth">
      {/* Zintegrowany Header */}
      <Header isScrolled={isScrolled} />

      <div className="max-w-3xl mx-auto pt-32 pb-20 px-4 sm:px-0">
        <h1 className="text-4xl font-bold mb-8 text-gray-900 dark:text-gray-100">Polityka prywatności Uczmy.pl</h1>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">1. Wprowadzenie</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Niniejsza Polityka prywatności określa, w jaki sposób Uczmy.pl („my”, „nasz”, „serwis”)
          gromadzi, wykorzystuje i chroni dane osobowe użytkowników. Korzystając z naszych usług,
          użytkownik akceptuje warunki opisane w niniejszym dokumencie.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">2. Zakres gromadzonych danych</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">Możemy gromadzić następujące rodzaje danych:</p>
        <ul className="list-disc ml-6 mb-4 text-gray-700 dark:text-gray-300">
          <li><strong>Dane osobowe:</strong> imię, adres e-mail oraz inne dane kontaktowe podane podczas rejestracji konta.</li>
          <li><strong>Dane dotyczące użytkowania:</strong> informacje o aktywności w Serwisie, takie jak czas logowania, odwiedzane strony, interakcje z funkcjami platformy.</li>
          <li><strong>Dane o urządzeniu:</strong> model urządzenia, system operacyjny, identyfikatory urządzenia.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">3. Wykorzystanie danych</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">Zebrane dane mogą być wykorzystywane w celu:</p>
        <ul className="list-disc ml-6 mb-4 text-gray-700 dark:text-gray-300">
          <li>zapewnienia dostępu do usług i ich ulepszania,</li>
          <li>wysyłania informacji technicznych i powiadomień dotyczących konta,</li>
          <li>prowadzenia analiz i statystyk zapewniających stabilność działania Serwisu.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">4. Udostępnianie danych</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">
          Nie sprzedajemy ani nie wynajmujemy danych osobowych użytkowników. Dane mogą być udostępniane wyłącznie:
        </p>
        <ul className="list-disc ml-6 mb-4 text-gray-700 dark:text-gray-300">
          <li>zaufanym podmiotom świadczącym usługi techniczne na rzecz Uczmy.pl, na podstawie umów o zachowaniu poufności,</li>
          <li>w przypadkach wymaganych przepisami prawa lub w celu ochrony naszych praw i bezpieczeństwa użytkowników.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">5. Bezpieczeństwo danych</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Stosujemy środki techniczne i organizacyjne zgodne z aktualnymi standardami branżowymi, aby chronić dane użytkowników.
          Jednak żaden sposób przesyłania danych przez Internet nie gwarantuje pełnego bezpieczeństwa.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">6. Okres przechowywania danych</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Dane osobowe przechowujemy tylko przez okres niezbędny do realizacji celów określonych w niniejszej Polityce prywatności,
          lub tak długo, jak jest to wymagane przepisami prawa.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">7. Prawa użytkownika</h2>
        <p className="mb-2 text-gray-700 dark:text-gray-300">Użytkownik ma prawo do:</p>
        <ul className="list-disc ml-6 mb-4 text-gray-700 dark:text-gray-300">
          <li>uzyskania dostępu do swoich danych oraz ich poprawiania,</li>
          <li>żądania usunięcia danych, z zastrzeżeniem obowiązujących przepisów,</li>
          <li>rezygnacji z otrzymywania wiadomości nieistotnych dla działania Serwisu.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">8. Prywatność dzieci</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Serwis nie jest przeznaczony dla osób poniżej 13. roku życia. Nie zbieramy świadomie danych osobowych dzieci.
          W przypadku wykrycia takich danych podejmiemy działania w celu ich niezwłocznego usunięcia.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">9. Zmiany w Polityce prywatności</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Zastrzegamy sobie prawo do okresowej aktualizacji niniejszej Polityki. W przypadku istotnych zmian poinformujemy użytkowników za pośrednictwem poczty e-mail lub bezpośrednio w Serwisie.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-200">10. Kontakt</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          W przypadku pytań lub wątpliwości dotyczących przetwarzania danych osobowych, prosimy o kontakt pod adresem: <a href="mailto:pomoc@uczmy.pl" className="underline text-blue-600 dark:text-blue-400">pomoc@uczmy.pl</a>.
        </p>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Zgodność z RODO oraz innymi przepisami o ochronie danych osobowych jest w trakcie wdrażania.
        </p>

        <p className="mt-12 text-sm text-gray-500 dark:text-gray-400">
          Data ostatniej aktualizacji: 6 maja 2025 r.
        </p>
      </div>
      
      {/* Zintegrowany, rozbudowany Footer */}
      <Footer />
    </main>
  );
}